...
The final layer of the model is passed through a softmax activation function \textcolor{red}{\textbf{(TODO add reference to softmax function)}} to predict one of the 500 word labels.

...
A direct comparison of the models on the Validation data shows that the Blendshape Channel architecture slightly outperforms the Multiple Towers architecture.

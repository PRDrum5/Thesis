...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{figures/shape_params_normalised_hist.png}
...
\subsection{Classification Model 1}
\begin{figure}[h]
    \centering
        \includegraphics[width=0.9\textwidth]{figures/classifier1.png}
    \caption{Multiple Towers Classification Architecture}
\end{figure}

\subsection{Classification Model 2}
\begin{figure}[h]
    \centering
        \includegraphics[width=0.9\textwidth]{figures/classifier2.png}
    \caption{Shape Channels Classification Architecture}
\end{figure}
